...
const (
	PixService_RegisterPixKey_FullMethodName = "/application.PixService/RegisterPixKey"
	PixService_Find_FullMethodName           = "/application.PixService/Find"
)
...
var PixService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "application.PixService",
